...
/**
 * @Author: siskin_zh
 * @Date: 2020 2020-09-04 16:24
 */
@Getter
@ToString
@EqualsAndHashCode(callSuper = true)
public class OptRecipeAnalyseExecutor extends AnalyseExecutor {
    public OptRecipeAnalyseExecutor(){
        super();
    }

    @Builder
    public OptRecipeAnalyseExecutor(Long id,Long analyseDetailId,Long zoneId,Date keyDate,Integer analyseType,
