...
public class IptPatientAnalyseExecutor extends AnalyseExecutor {
    public IptPatientAnalyseExecutor(){

    }

    @Builder
    public IptPatientAnalyseExecutor(Long id,Long analyseDetailId,Long zoneId,Date keyDate,Integer analyseType,
    ...
    public List<String> getDiagnoseInfo(){
        return null;
    }
    ...
    public List<String> getDrugsInfo(){
        return null;
    }
}
